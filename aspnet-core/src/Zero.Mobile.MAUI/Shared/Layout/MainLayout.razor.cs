...
using Zero.Mobile.MAUI.Services.Tenants;

#if ANDROID
using Zero.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Zero.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Zero.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
