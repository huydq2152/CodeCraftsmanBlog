...
namespace Zero.Migrations
{
    ...
    [Migration("20231219093245_CCB_Post_Post")]
    partial class CCB_Post_Post
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CCB.Core.Post.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CCB_Post_Post");
                });

            modelBuilder.Entity("CCB.Core.Post.PostCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Zero.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CCB.Core.Post.Post", b =>
                {
                    b.HasOne("CCB.Core.Post.PostCategory", "PostCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("CCB.Core.Post.PostCategory", b =>
                {
                    b.HasOne("CCB.Core.Post.PostCategory", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");
