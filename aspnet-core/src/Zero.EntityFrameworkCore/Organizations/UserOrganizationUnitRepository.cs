...
namespace Zero.Organizations
{
    public class UserOrganizationUnitRepository : ZeroRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<ZeroDbContext> dbContextProvider)
