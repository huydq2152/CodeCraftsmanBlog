...
using Zero.Core.Base;
using Zero.Core.Extensions;
using Zero.Dto;
using Zero.Types;

namespace Zero.Queries
{
    public class OrganizationUnitQuery : ZeroQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
