...
namespace Zero.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ZeroAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ZeroDbContext> _migrator;
