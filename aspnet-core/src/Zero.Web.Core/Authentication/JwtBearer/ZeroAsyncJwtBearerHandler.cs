...
namespace Zero.Web.Authentication.JwtBearer
{
    public class ZeroAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public ZeroAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
