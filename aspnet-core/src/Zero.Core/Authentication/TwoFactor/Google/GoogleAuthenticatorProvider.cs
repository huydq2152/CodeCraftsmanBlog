...
namespace Zero.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ZeroServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Zero", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
